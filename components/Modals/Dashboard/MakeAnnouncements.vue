<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl mx-4">
      ...
      <footer class="p-4 border-t border-gray-200 bg-gray-50 flex justify-end space-x-3">
        <button
          @click="$emit('close')"
        ...
        <button
          @click="saveDraft"
          class="px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50"
        >
          Save Draft
        </button>
        <button

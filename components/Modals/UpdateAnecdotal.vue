<template>
    <div class="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div v-if="showConfirmationModal" class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div
            class="inline-block w-full max-w-md overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle">
            <div class="px-6 py-4 bg-gray-50 border-b">
              <h3 class="text-lg font-medium text-gray-900">Confirm Update</h3>
            </div>
            <div class="px-6 py-4">
              <p class="text-sm text-gray-700">Once submitted, this report cannot be modified or deleted. Are you sure you want to proceed?</p>
            </div>
  ...
  export default {
    ...
    methods: {
      handleSubmit() {
        this.showConfirmationModal = true; // Show confirmation modal on submit
      },

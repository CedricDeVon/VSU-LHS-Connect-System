...
export const getSectionIDByName = (name, sy) => {
  const index = section.findIndex(
    (sec) => sec.sectionName === name && sec.sectionSchoolYear === sy
  );
  if (index !== -1) {
...
export const section = [
...

  {
    ...
    sectionStudents: ["sample22-1-10075"],
  },
...

  {
    ...
    sectionLevel: "8",
    sectionSchoolYear: "2023-2024",
    sectionStudents: ["sample22-1-10110"],
  },
  ...
  },
  {
    ...
    sectionLevel: "10",
    sectionSchoolYear: "2023-2024",
    sectionStudents: ["sample22-1-10000"],
  },
  {
    id: "sectionid17",
...

  {
    ...
    sectionLevel: "12",
    sectionSchoolYear: "2023-2024",
    sectionStudents: ["sample22-1-10801"],
  },

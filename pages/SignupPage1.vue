...
const signUpEmail = useState('signUpEmail');
const signUpPassword = useState('signUpPassword');
const signUpConfirmPassword = useState ('signUpConfirmPassword');
const signUpErrorMessage = useState('signUpErrorMessage');
      ...
      <div class="w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden signup-outer-container">
        <div class="w-full p-8 bg-amber-50 signup-container">
          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div v-if ="signUpErrorMessage" class="text-red-500 mb-4">{{ signUpErrorMessage }}</div>
            <button
              type="submit"

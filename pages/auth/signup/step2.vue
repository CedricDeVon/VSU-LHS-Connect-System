...
import Datepicker from '~/components/Datepicker.vue'; // Ensure this import is correct
    ...
    <div class="w-1/2 flex items-center justify-center bg-left h-screen">
      <div class="w-[480px] animate-slide-in">
        <form 
          ...
          <!-- Faculty ID -->
          <div class="relative transform transition-all duration-300 hover:scale-[1.02]">
            <label class="block text-[#2B5741] text-sm mb-1">Faculty Identification Number (If Applicable)</label>
            <input 
              type="text" 
          ...
          <!-- Proceed Button -->
          <button type="submit" @click="navigateTo('/auth/signup/success', { replace: true });"
